...
system(paste("bedtools getfasta -s -name -fi",  genomeFile, "-bed", three_UTR_gff, "-fo three_UTR_exons.fa", sep = " "))
fa <- readDNAStringSet("three_UTR_exons.fa")
...
writeXStringSet(faThreeUTR, filepath = (paste(outPath, "/three_UTR.fa", sep = "")))
